...
ggsave(paste0(outputdir,"prelim_ste_heatmaps.png"),width = 13,height = 13)
...
plot_grid(pOut_type.dataobs+theme(legend.position="none"),pDataobs.stdytype+theme(legend.position="none"),pDataobs.type,  
           labels=letters[1:3], 
