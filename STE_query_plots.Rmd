...
pdf(file=paste0(fig.outputdir,"fig1_Auth_Study_Country_Map_dark.pdf"), width=13.5, height=16)
...
ggsave(paste0(fig.outputdir,'fig3_STE intervention waffle.pdf'),width = 8,height = 4)
...
pdf(file=paste0(fig.outputdir,"fig4_Heatmap_articles.pdf"), width=13.5, height=5)
...
pdf(file=paste0(fig.outputdir,"fig5_Outcome_attr_by_domain_all.pdf"), width=9, height=8)
treemap(outcomes3,index=c("Out_type_all","Out_subtype"),
        vSize="n",
        type="index",
        fontsize.labels = c(15,10),
...
ggsave(paste0(fig.outputdir,"fig6_syn_trd_both_heatmaps.pdf"),width = 13,height = 13)
...
ggsave(paste0(fig.outputdir,'fig7_STE outcome-data observer.pdf'),width = 14,height = 4)
...
ggsave(paste0(fig.outputdir,'fig8_STE outcome-studytype.pdf'),width = 7,height = 4)
