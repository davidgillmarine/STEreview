...
pSTE_time_gps <- ggplot(STE_time_gps)  + 
 ...
 ggsave(paste0(datadir,'STE main gps.jpg'),width = 13,height = 7)
...
# Control group
table(data$Design.control_comp)
