...
#### For paper
```{r, EVAL =F}
# Fig2. Study design and outcome types 
...
#ggsave(paste0(fig.outputdir,'fig2_STE outcome-data observer.jpg'),width = 14,height = 4)
ggsave(paste0(fig.outputdir,'fig2_STE outcome-data observer.pdf'),width = 14,height = 4)

# Fig3 Outcome types by type of study for 195 social outcomes 
pOut_type.stdytype
#ggsave(paste0(fig.outputdir,'fig3_STE outcome-studytype.jpg'),width = 7,height = 4)
ggsave(paste0(fig.outputdir,'fig3_STE outcome-studytype.pdf'),width = 7,height = 4)

# Fig4. Study and author country
#png(file=paste0(fig.outputdir,"fig4_Auth_Study_Country_Map_dark.png"), width=13.5, height=16, res=600, units = "in")
pdf(file=paste0(fig.outputdir,"fig4_Auth_Study_Country_Map_dark.pdf"), width=13.5, height=16)
...
# Fig5. study growth over time
plot_grid(pInt_time_gps, pSTE_time_dom,pSTE_time_demog,pSTE_scale_gps,
          labels=letters[1:4], ncol = 2, nrow = 2, hjust=-1)
#ggsave(paste0(fig.outputdir,'fig5_study_gps_over_time.jpg'),width = 14,height = 8)
ggsave(paste0(fig.outputdir,'fig5_study_gps_over_time.pdf'),width = 14,height = 8)
...
# Fig8. Distribution of domains and sub-domains 
# All interventions
#png(file=paste0(fig.outputdir,"fig8_Outcome_attr_by_domain_all.png"), width=9, height=8, res=600, units = "in")
pdf(file=paste0(fig.outputdir,"fig8_Outcome_attr_by_domain_all.pdf"), width=9, height=8)
treemap(outcomes3,index=c("Out_type_all","Out_subtype"),
        vSize="n",
        type="index",
        fontsize.labels = c(15,10),
...
# Fig9. Heat maps showing the number of reported synergies (a,d,g), tradeoffs 
...
plot_grid(mpa.counts.syn+theme(legend.position = "none",axis.title.y=element_text(face="bold"))+labs(y="MPA",title="Synergy"),
          ...
          cert.counts.both+theme(legend.position = "none"),
          labels=letters[1:9], ncol = 3, nrow = 3, hjust=-1)
#ggsave(paste0(fig.outputdir,"fig9_syn_trd_both_heatmaps.png"),width = 13,height = 13)
ggsave(paste0(fig.outputdir,"fig9_syn_trd_both_heatmaps.pdf"),width = 13,height = 13)
